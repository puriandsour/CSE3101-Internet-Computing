...
class ClassModel extends Model
{
    ...
    public function create($classData)
    {
        try {
            ...
            $nameSql = "SELECT id FROM classes WHERE name = ?";
            $nameStmt = $this->db->prepare($nameSql);
            $nameStmt->execute([$classData['name']]);
    ...
    public function update($classId, $classData)
    {
        try {
            ...
            if (isset($classData['name'])) {
                ...
                $nameSql = "SELECT id FROM classes WHERE name = ? AND id != ?";
                $nameStmt = $this->db->prepare($nameSql);
                $nameStmt->execute([$classData['name'], $classId]);
